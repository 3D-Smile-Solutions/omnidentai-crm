...
const DocumentViewer = ({ open, onClose, category, title, documentType, onUpload }) => {
  ...
  const getFileIcon = (mimeType) => {
    ...
    if (mimeType?.startsWith('image/')) 
      return <ImageIcon sx={{ ...iconProps, color: isDarkMode ? '#34d399' : '#2E7D32' }} />;
    if (mimeType === 'application/pdf') 
      return <PdfIcon sx={{ ...iconProps, color: isDarkMode ? '#f87171' : '#dc2626' }} />;
    if (mimeType?.includes('word') || mimeType?.includes('document')) 
      return <DocIcon sx={{ ...iconProps, color: isDarkMode ? '#60a5fa' : '#1976D2' }} />;
    return <FileIcon sx={{ ...iconProps, color: isDarkMode ? '#a78bfa' : '#7B1FA2' }} />;
  };
    ...
    <>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 0.5 }}>
                ...
                >
                  {formatFileSize(categoryDocuments.reduce((acc, doc) => acc + doc.file_size, 0))} total
                </Typography>
              </Box>
            </Box>
          </Box>
            ...
            <Tooltip title="Upload New Document">
              <Button
                ...
                startIcon={
                  ...
                  >
                    <AddIcon sx={{ fontSize: 18, color: isDarkMode ? '#64ffda' : '#3EE4C8' }} />
                  </Box>
                }
                sx={{
        ...
        <DialogContent sx={{ mt: 3, position: 'relative', pb: 3 }}>
          {loading ? (
            ...
            <Box sx={{ 
              ...
              >
                Upload your first document to get started. You can drag and drop files or click the button below.
              </Typography>
                ...
                startIcon={
                  <Box
                    sx={{
                      ...
                      height: 28,
                      borderRadius: '50%',
                      backgroundColor: isDarkMode ? '#0B1929' : 'rgba(255, 255, 255, 0.9)',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      mr: 0.5,
                  ...
                  >
                    <AddIcon sx={{ fontSize: 20, color: isDarkMode ? '#64ffda' : '#3EE4C8' }} />
                  </Box>
                }
                sx={{
                  backgroundColor: isDarkMode ? '#64ffda' : '#3EE4C8',
                ...
                <Grid item xs={12} sm={6} md={4} key={doc.id}>
                  <Card 
                    ...
                    sx={{
                      ...
                      cursor: 'pointer',
                      overflow: 'hidden',
                      transform: hoveredCard === doc.id ? 'translateY(-8px)' : 'translateY(0)',
                      '&:hover': {
                        border: isDarkMode 
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        ...
                        background: `linear-gradient(135deg, 
                          ${isDarkMode ? 'rgba(100, 255, 218, 0.05)' : 'rgba(62, 228, 200, 0.05)'} 0%, 
                          transparent 100%)`,
                    ...
                    {doc.mime_type?.startsWith('image/') ? (
                      ...
                      >
                        ...
                        {new Date(doc.uploaded_at) > new Date(Date.now() - 24 * 60 * 60 * 1000) && (
                          <Chip
                            size="small"
                            label="NEW"
                            sx={{
      ...
      >
        <MenuItem onClick={() => handleView(selectedDoc)}>
          <ViewIcon sx={{ mr: 1.5, fontSize: 20, color: isDarkMode ? '#64ffda' : '#3EE4C8' }} />
          View
        </MenuItem>
        <MenuItem onClick={() => handleDownload(selectedDoc)}>
          <DownloadIcon sx={{ mr: 1.5, fontSize: 20, color: isDarkMode ? '#60a5fa' : '#1976D2' }} />
          Download
        </MenuItem>
        <MenuItem 
