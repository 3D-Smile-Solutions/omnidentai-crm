...
// import DashboardPatients from './Patients';
// import DashboardForms from './Forms';
// import DashboardReports from './Reports';
// import DashboardPracticeEnhancer from './PracticeEnhancer';
// import DashboardSettings from './Settings';
// import DashboardSessionHistory from './SessionHistory';

// const Dashboard = ({ currentUser, isMobile, patients, patientTypes, revenueByType, patientSatisfaction, handleSendMessage }) => {
...
//       case 0: return <DashboardOverview patientTypes={patientTypes} revenueByType={revenueByType} patientSatisfaction={patientSatisfaction} isMobile={isMobile} />;
//       case 1: return <DashboardPatients patients={patients} selectedPatient={selectedPatient} setSelectedPatient={setSelectedPatient} handleSendMessage={handleSendMessage} isMobile={isMobile} />;
//       case 2: return <DashboardForms />;
//       case 3: return <DashboardReports />;
//       case 4: return <DashboardPracticeEnhancer isMobile={isMobile} />;
//       case 5: return <DashboardSettings setSelectedIndex={setSelectedIndex} isMobile={isMobile} />;
//       case 6: return <DashboardSessionHistory />;
//       default: return null;
//     }
//   };
...
//     <Box sx={{ display: 'flex' }}>
//       <CssBaseline />
//       <DashboardHeader drawerWidth={drawerWidth} handleDrawerToggle={handleDrawerToggle} currentUser={currentUser} anchorEl={anchorEl} handleMenuOpen={handleMenuOpen} handleMenuClose={handleMenuClose} handleLogout={handleLogout} />
//       <DashboardDrawer drawerWidth={drawerWidth} mobileOpen={mobileOpen} handleDrawerToggle={handleDrawerToggle} selectedIndex={selectedIndex} setSelectedIndex={setSelectedIndex} />
